...
export const CardTool = ({
	...
	return (
		<div className="shadow-xs w-full overflow-hidden whitespace-nowrap rounded-md border border-gray-200 dark:border-gray-600 dark:bg-gray-600 lg:grid lg:grid-cols-8 lg:gap-3">
			<div
...
export default function CardWithImageTool({ item, sticky }: Props) {
	return (
		<div
			className={`shadow-xs w-full rounded-md border bg-white dark:border-gray-700 dark:bg-gray-800 ${
			...
			<div className="p-5 lg:p-10">
				...
				<div className="mt-6">
					<Link href={`/post/${item.id}`}>
						<h1
							className="mb-5 text-2 font-medium tracking-wider text-gray-700 dark:text-white lg:text-list-title"
