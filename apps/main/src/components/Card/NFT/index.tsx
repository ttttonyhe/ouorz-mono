		...
		<div className="glowing-div z-40 flex w-50 cursor-pointer items-center rounded-md border bg-white shadow-xs transition-shadow hover:shadow-md dark:border-none dark:bg-gray-700">
			...
			<div className="glowing-div-content top-[0.5px] right-0 bottom-0 left-0 h-full overflow-hidden rounded-[5px]">
				...
				<div className="px-3.5 pb-5">
					<div className="-mt-3.5 z-30 mb-3 flex w-full justify-center">
						<a
							className="inline-block w-28 overflow-hidden text-ellipsis rounded-full border border-gray-300 bg-gray-100 px-2 py-0.5 text-gray-600 text-sm shadow-xs dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300"
							href={tokenLink}
							target="_blank"
							rel="noreferrer">
					...
					<div onClick={() => openLink(link)}>
						<h2 className="mb-0.5 overflow-hidden text-ellipsis whitespace-nowrap font-medium text-2 tracking-wider">
							{props.title}
						</h2>
						<p className="line-clamp-2 text-3 text-gray-600 leading-snug tracking-wide dark:text-gray-400">
							{description}
						</p>
					</div>
				</div>
