	...
	if (type === "sm") {
		return (
			<div
				...
				className="my-2 flex w-full flex-col gap-y-3 rounded-md border bg-white px-4.5 py-4 shadow-xs lg:flex-row lg:items-center lg:gap-x-10 lg:gap-y-0 lg:space-x-4 lg:py-3 dark:border-gray-700 dark:bg-gray-800">
				<div>
					<p className="flex items-center whitespace-nowrap text-gray-600 text-xl tracking-wide dark:text-gray-300">
					...
					{subscribed ? (
						...
						<form
							...
							<input
								...
								} flex h-8 w-full rounded-md border bg-white px-4 text-4 text-gray-500 tracking-wide shadow-xs focus:outline-hidden dark:border-gray-700 dark:bg-gray-700 dark:text-gray-400`}
							...
							{email && email.length <= 23 && (
								<button
									type="submit"
									className="effect-pressing absolute top-[6.5px] right-1.5 hidden animate-appear rounded-full bg-slate-500 px-[8px] py-[2px] text-white text-xs shadow-xs hover:bg-neutral-600 hover:shadow-inner lg:block dark:bg-neutral-800 dark:text-gray-300">
									Subscribe
								</button>
							)}
							<button
								type="submit"
								className="effect-pressing absolute top-[6.5px] right-1.5 animate-appear rounded-full bg-slate-500 px-[8px] py-[2px] text-white text-xs shadow-xs hover:bg-neutral-600 hover:shadow-inner lg:hidden dark:bg-neutral-800 dark:text-gray-300">
								Subscribe
							</button>
						</form>
					)}
		...
		<div
			...
			<div className="flex justify-between">
				...
				<div className="flex items-center">
					<a href="https://lipeng.ac/feed" target="_blank" rel="noreferrer">
						<button className="effect-pressing -mt-4.5 flex w-full cursor-pointer items-center justify-center gap-x-1 rounded-md border border-gray-300 bg-white px-2.5 py-1 text-gray-500 text-xl tracking-wider shadow-xs hover:shadow-inner focus:outline-hidden dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
			...
			<div className="grid w-full grid-cols-3 gap-5">
				<form
					...
					className="col-start-1 col-end-3 grid w-full grid-cols-3 rounded-md bg-white text-gray-600 tracking-wide dark:border-gray-800 dark:bg-gray-800 dark:text-gray-400">
					<input
						type="email"
						value={email}
						className="col-start-1 col-end-3 w-full rounded-tl-md rounded-bl-md border border-gray-200 border-r-0 px-4 py-2 font-light shadow-xs focus:border-gray-300 focus:outline-hidden dark:border-gray-500 dark:bg-gray-600"
