  ...
  return (
    <div className="mt-4 grid xl:grid-cols-5 lg:gap-3">
      <div className="grid-cols-3 gap-3 col-start-1 col-span-3 hidden lg:grid">
        ...
        >
          <Button
            bType="default"
            icon="github"
            className="text-gray-700 text-3"
          >
      ...
      <div className="lg:col-start-4 lg:col-end-6">
        <Link href="/post/126">
          <a>
            <Button bType="primary" icon="right" className="text-3">
