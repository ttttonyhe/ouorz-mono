  ...
  return (
    data.post.length !== 0 && (
      <div>
        ...
        ></div>
        <div
          className={`fixed bg-white shadow-md reader overflow-y-auto overflow-hidden rounded-tl-xl rounded-tr-xl px-20 py-16 w-page mx-auto top-0 mt-28 ml-readerOffset ${
        ...
        >
          ...
          <PostContent content={data.post.content.rendered}></PostContent>
        </div>
      </div>
    )
  )
